...
const NAV_COMMANDS = [
  ...
  { id: 'nav-tools',    label: 'WokTool (Dev Tools)',  href: 'https://woktool.wokspec.org', group: 'Platform' },
  ...
  { id: 'tool-upscale',     label: '4× Upscaler',        href: 'https://woktool.wokspec.org/tools/upscale',     group: 'Tools' },
  { id: 'tool-interrogate', label: 'Image Interrogator',  href: 'https://woktool.wokspec.org/tools/interrogate', group: 'Tools' },
  { id: 'tool-music',       label: 'Music Generator',     href: 'https://woktool.wokspec.org/tools/music',       group: 'Tools' },
  { id: 'tool-sfx',         label: 'SFX Library',         href: 'https://woktool.wokspec.org/tools/sfx',         group: 'Tools' },
  { id: 'tool-assets',      label: 'Asset Library',       href: 'https://woktool.wokspec.org/tools/assets',      group: 'Tools' },
  { id: 'tool-palette',     label: 'Color Palette',       href: 'https://woktool.wokspec.org/tools/palette',     group: 'Tools' },
