  ...
  return (
    <div style={{ padding: '4rem 2rem', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center' }}>
        ...
        <a href="/uiux/studio" style={{ padding: '0.5rem 1.25rem', background: 'var(--surface-raised)', border: '1px solid var(--border)', borderRadius: '6px', color: 'var(--text-muted)', fontSize: '0.875rem', textDecoration: 'none' }}>
          Back to studio
        </a>
      </div>
    </div>
