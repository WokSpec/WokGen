    ...
    <main style={{ maxWidth: 680, margin: '0 auto', padding: '4rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <Section title="3. Third-Party Services">
        <ul style={{ paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
          <li><strong style={{ color: 'var(--text)' }}>Vercel</strong> — hosting. Your requests are processed on Vercel infrastructure. <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#a78bfa', textDecoration: 'none' }}>Privacy policy →</a></li>
          <li><strong style={{ color: 'var(--text)' }}>Neon</strong> — serverless PostgreSQL database hosting your account and generation data. <a href="https://neon.tech/privacy" target="_blank" rel="noopener noreferrer" style={{ color: '#a78bfa', textDecoration: 'none' }}>Privacy policy →</a></li>
          <li><strong style={{ color: 'var(--text)' }}>Stripe</strong> — payment processing. Governed by Stripe&apos;s privacy policy. <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" style={{ color: '#a78bfa', textDecoration: 'none' }}>Privacy policy →</a></li>
          <li><strong style={{ color: 'var(--text)' }}>Resend</strong> — transactional email delivery. <a href="https://resend.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" style={{ color: '#a78bfa', textDecoration: 'none' }}>Privacy policy →</a></li>
          <li><strong style={{ color: 'var(--text)' }}>GitHub OAuth</strong> — authentication. We receive only your public profile and primary email. <a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noopener noreferrer" style={{ color: '#a78bfa', textDecoration: 'none' }}>Privacy statement →</a></li>
      ...
      <Section title="5. Your Rights">
        ...
        <a href="mailto:privacy@wokspec.org" style={{ color: '#a78bfa', textDecoration: 'none', marginLeft: '0.25rem' }}>privacy@wokspec.org</a>.
      ...
      <Section title="9. Contact">
        <p>Privacy questions: <a href="mailto:privacy@wokspec.org" style={{ color: '#a78bfa', textDecoration: 'none' }}>privacy@wokspec.org</a></p>
        <p>General contact: <a href="mailto:team@wokspec.org" style={{ color: '#a78bfa', textDecoration: 'none' }}>team@wokspec.org</a></p>
      </Section>
